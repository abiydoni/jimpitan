...
<body class="min-h-screen bg-slate-50 dark:bg-dark transition-colors duration-300">
        ...
        <div class="space-y-4 animate__animated animate__fadeInUp">
            ...
            <?php foreach($days as $day): ?>
                <?php if(isset($jadwal[$day])): ?>
                    <div class="day-card glass rounded-[1.5rem] p-4 <?= $day === $today ? 'today active shadow-xl' : 'shadow-sm' ?>">
                        ...
                        <div class="grid grid-cols-1 gap-1.5">
                            <?php foreach($jadwal[$day] as $user): ?>
                                <div class="group relative flex items-center space-x-2.5 p-2 bg-white/50 dark:bg-slate-800/50 rounded-xl border border-slate-100 dark:border-slate-800 shadow-sm">
    ...
    <div class="md:hidden bottom-nav">
        ...
        <a href="/jadwal_jaga" class="nav-item active">
    ...
    <script>
        ...
        async function openSelectUserModal(day) {
            ...
            if (allUsers.length === 0) {
                try {
                    const response = await fetch('/jadwal/get_users');
